...
export default function Footer() {
  ...
  <div className="text-center">
    <span className="inline-block rounded-full bg-background px-4 py-2 text-sm font-bold uppercase text-accent md:text-base lg:text-lg">
      Made By
    </span>
  </div>
        ...
        >
          <span>Mohammad Omar Shahab 22102233</span>
          <br />
          <br />
          <span>Shivyansh Garg 22102031</span>
        </a>
      ...
      <div className="flex w-full flex-col items-center justify-between gap-8 text-center  md:flex-row md:justify-between lg:mx-auto lg:max-w-7xl">
        <span className="text-foreground">©2025 Omar&Shivyansh</span>
